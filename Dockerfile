...
ARG ERIC_ENM_SLES_EAP7_IMAGE_TAG=1.63.0-42
...
org.label-schema.name="ENM Mplane Router Policy SG" \
...
RUN zypper install -y ERICserviceframework4_CXP9037454 \
	...
	rpm -ivh /var/tmp/ERICenmsgmplanerouterpolicy_CXP9043937*.rpm --nodeps --noscripts && \
	zypper clean -a
	
ENV ENM_JBOSS_SDK_CLUSTER_ID="mplanerouterpolicy" \
